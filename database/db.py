...
def seed_db():
    ...
    expenses = [
        ...
        (user_id, 25.00,  "Entertainment", "2026-06-09", "Movie ticket"),
        (user_id, 80.00,  "Shopping",      "2026-06-11", "Clothing"),
        (user_id, 9.99,   "Other",         "2026-06-13", "Miscellaneous"),
        (user_id, 18.75,  "Food",          "2026-06-15", "Dinner with friends"),
    ]
    conn.executemany(
